...
namespace br2_fsm_bumpgo_cpp_ex2_cl  // This helps to keep the code organized and reduces the likelihood of naming conflicts with other parts of the program or external libraries
{

using namespace std::chrono_literals;  // NOLINT

class BumpGoNodeEx2CL : public rclcpp::Node
{
public:
  BumpGoNodeEx2CL();
...
private:
  ...
  const rclcpp::Duration BACKING_TIME {0.5s};
  ...
  static constexpr float OBSTACLE_FREE_DISTANCE = 3.0f;  // added code

  std::string obstacle_direction;
